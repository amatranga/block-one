...
var _registerServiceWorker = __webpack_require__(31);
...
var _eosjs = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"eosjs\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var _HeadBlockInfo = __webpack_require__(29);

var _HeadBlockInfo2 = _interopRequireDefault(_HeadBlockInfo);

var _LatestButton = __webpack_require__(30);

var _LatestButton2 = _interopRequireDefault(_LatestButton);
...
var eos = _eosjs2.default.Testnet();
  ...
  _createClass(App, [{
    ...
    value: function handleClick(e) {
      ...
      eos.getInfo({}).then(function (res) {
        return eos.getBlock(res.head_block_num).then(function (block) {
    ...
    value: function render() {
      if (this.state.block_num !== null) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_LatestButton2.default, { handleClick: this.handleClick }),
          _react2.default.createElement(_HeadBlockInfo2.default, { info: this.state })
        );
      } else {
        return _react2.default.createElement(
          'div',
...
var Header = function Header() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "h2",
      null,
      " Get the latest EOS block from the public testnet "
    )
  );
};
...
var HeadBlockInfo = function HeadBlockInfo(props) {
  var info = props.info;
  return _react2.default.createElement(
    "ul",
    ...
    _react2.default.createElement(
      ...
      null,
      "producer_changes: ",
      info.producer_changes
    ),
    _react2.default.createElement(
      "li",
      null,
      "producer_signature: ",
      info.producer_signature
    ),
    _react2.default.createElement(
      "li",
      null,
      "ref_block_prefix: ",
      info.ref_block_prefix
    ),
    _react2.default.createElement(
      "li",
      null,
    ...
    _react2.default.createElement(
      ...
      info.transaction_merkle_root
    )
  );
};

exports.default = HeadBlockInfo;
...
var LatestButton = function LatestButton(props) {
  return _react2.default.createElement(
    "div",
    { className: "row justify-content-center col-12" },
    _react2.default.createElement(
